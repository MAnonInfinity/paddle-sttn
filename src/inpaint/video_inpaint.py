...
from src.inpaint.video.model.modules.flow_comp_raft import RAFT_bi
from src.inpaint.video.model.recurrent_flow_completion import RecurrentFlowCompleteNet
from src.inpaint.video.model.propainter import InpaintGenerator
from src.inpaint.video.core.utils import to_tensors
from src.inpaint.video.model.misc import get_device
...
if __name__ == '__main__':
    ...
    frames = read_frames('local_test/test1.mp4')
    mask = cv2.imread('local_test/test1_mask.png')
    inpainted_frames = video_inpaint.inpaint(frames, mask)
    save_root = 'local_test/'
