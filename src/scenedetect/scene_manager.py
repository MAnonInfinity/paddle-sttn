...
:class:`VideoCaptureAdapter <scenedetect.srcs.opencv.VideoCaptureAdapter>` instead of
`open_video`.
...
import cv2
import numpy as np
from src.scenedetect._thirdparty.simpletable import (SimpleTableCell, SimpleTableImage, SimpleTableRow,
                                                 SimpleTable, HTMLPage)

from src.scenedetect.platform import (tqdm, get_and_create_path, get_cv2_imwrite_params, Template)
from src.scenedetect.frame_timecode import FrameTimecode
from src.scenedetect.video_stream import VideoStream
from src.scenedetect.scene_detector import SceneDetector, SparseSceneDetector
from src.scenedetect.stats_manager import StatsManager, FrameMetricRegistered
    ...
    def detect_scenes(self,
        ...
        Arguments:
            video: VideoStream obtained from either `scenedetect.open_video`, or by creating
                one directly (e.g. `scenedetect.srcs.opencv.VideoStreamCv2`).
