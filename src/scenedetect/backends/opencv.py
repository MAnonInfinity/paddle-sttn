...
src. Works with video files, image sequences, and network streams/URLs.
...
from src.scenedetect.frame_timecode import FrameTimecode, MAX_FPS_DELTA
from src.scenedetect.platform import get_file_name
from src.scenedetect.video_stream import VideoStream, SeekError, VideoOpenFailure, FrameRateUnavailable
...
class VideoStreamCv2(VideoStream):
    ...
    BACKEND_NAME = 'opencv'
    """Unique name used to identify this src."""
    ...
    def _open_capture(self, framerate: Optional[float] = None):
        ...
        # addressed in the PyAV src if required since it supports integer timebases.
